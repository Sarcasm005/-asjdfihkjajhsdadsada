...
class Keyboard:
    ...
    def technique_staining(self,message):
        ...
        tech_markup.add(telebot.types.InlineKeyboardButton(text = 'Вернуться в главное меню', callback_data = 'menu'))
    ...
    def contacts(self, message):
        ...
        contacts_markup.add(telebot.types.InlineKeyboardButton(text = 'Vk', url = 'https://vk.com/id'))
        contacts_markup.add( telebot.types.InlineKeyboardButton(text = 'Instagram', url = 'https://Instagram.com/id'))
        contacts_markup.add(telebot.types.InlineKeyboardButton(text = 'Наш сайт', url = 'https://yandex.com'))
        contacts_markup.add( telebot.types.InlineKeyboardButton(text = 'Вернуться в главное меню', callback_data = 'menu'))
